 ...
 */
class getIvory_GoogleMap_Helper_Subscriber_Place_Autocomplete_Event_EventOnceService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ivory.google_map.helper.subscriber.place.autocomplete.event.event_once' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['ivory.google_map.helper.subscriber.place.autocomplete.event.event_once'] = new \Ivory\GoogleMap\Helper\Subscriber\Place\Event\AutocompleteEventOnceSubscriber(($container->privates['ivory.google_map.helper.formatter'] ?? ($container->privates['ivory.google_map.helper.formatter'] = new \Ivory\GoogleMap\Helper\Formatter\Formatter(true))), new \Ivory\GoogleMap\Helper\Collector\Place\Event\AutocompleteEventOnceCollector(), ($container->privates['ivory.google_map.helper.renderer.event.event_once'] ?? $container->load('getIvory_GoogleMap_Helper_Renderer_Event_EventOnceService')));
    }
}
