...
require_once __DIR__.\DIRECTORY_SEPARATOR.'PlaceDetail'.\DIRECTORY_SEPARATOR.'BusinessAccountConfig.php';
...
class PlaceDetailConfig 
{
    ...
    public function businessAccount(array $value = []): \Symfony\Config\IvoryGoogleMap\PlaceDetail\BusinessAccountConfig
    {
        if (null === $this->businessAccount) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\PlaceDetail\BusinessAccountConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('business_account', $value)) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\PlaceDetail\BusinessAccountConfig($value['business_account']);
