...
require_once __DIR__.\DIRECTORY_SEPARATOR.'DistanceMatrix'.\DIRECTORY_SEPARATOR.'BusinessAccountConfig.php';
...
class DistanceMatrixConfig 
{
    ...
    public function businessAccount(array $value = []): \Symfony\Config\IvoryGoogleMap\DistanceMatrix\BusinessAccountConfig
    {
        if (null === $this->businessAccount) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\DistanceMatrix\BusinessAccountConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('business_account', $value)) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\DistanceMatrix\BusinessAccountConfig($value['business_account']);
