...
require_once __DIR__.\DIRECTORY_SEPARATOR.'TimeZone'.\DIRECTORY_SEPARATOR.'BusinessAccountConfig.php';
...
class TimeZoneConfig 
{
    ...
    public function businessAccount(array $value = []): \Symfony\Config\IvoryGoogleMap\TimeZone\BusinessAccountConfig
    {
        if (null === $this->businessAccount) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\TimeZone\BusinessAccountConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('business_account', $value)) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\TimeZone\BusinessAccountConfig($value['business_account']);
