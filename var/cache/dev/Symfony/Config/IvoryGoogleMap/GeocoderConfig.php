...
require_once __DIR__.\DIRECTORY_SEPARATOR.'Geocoder'.\DIRECTORY_SEPARATOR.'BusinessAccountConfig.php';
...
class GeocoderConfig 
{
    ...
    public function businessAccount(array $value = []): \Symfony\Config\IvoryGoogleMap\Geocoder\BusinessAccountConfig
    {
        if (null === $this->businessAccount) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\Geocoder\BusinessAccountConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('business_account', $value)) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\Geocoder\BusinessAccountConfig($value['business_account']);
