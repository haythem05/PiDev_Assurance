 ...
 */
class getIvory_GoogleMap_Helper_Subscriber_Place_Autocomplete_Event_DomEventOnceService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ivory.google_map.helper.subscriber.place.autocomplete.event.dom_event_once' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'ivory'.\DIRECTORY_SEPARATOR.'google-map'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Helper'.\DIRECTORY_SEPARATOR.'Collector'.\DIRECTORY_SEPARATOR.'Place'.\DIRECTORY_SEPARATOR.'Event'.\DIRECTORY_SEPARATOR.'AutocompleteDomEventOnceCollector.php';
        ...
        return $container->privates['ivory.google_map.helper.subscriber.place.autocomplete.event.dom_event_once'] = new \Ivory\GoogleMap\Helper\Subscriber\Place\Event\AutocompleteDomEventOnceSubscriber(($container->privates['ivory.google_map.helper.formatter'] ?? ($container->privates['ivory.google_map.helper.formatter'] = new \Ivory\GoogleMap\Helper\Formatter\Formatter(true))), new \Ivory\GoogleMap\Helper\Collector\Place\Event\AutocompleteDomEventOnceCollector(), ($container->privates['ivory.google_map.helper.renderer.event.dom_event_once'] ?? $container->load('getIvory_GoogleMap_Helper_Renderer_Event_DomEventOnceService')));
    }
}
