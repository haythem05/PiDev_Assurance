...
require_once __DIR__.\DIRECTORY_SEPARATOR.'StaticMap'.\DIRECTORY_SEPARATOR.'BusinessAccountConfig.php';
...
class StaticMapConfig 
{
    ...
    public function businessAccount(array $value = []): \Symfony\Config\IvoryGoogleMap\StaticMap\BusinessAccountConfig
    {
        if (null === $this->businessAccount) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\StaticMap\BusinessAccountConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('business_account', $value)) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\StaticMap\BusinessAccountConfig($value['business_account']);
