 ...
 */
class getIvory_GoogleMap_Helper_Subscriber_Place_Autocomplete_Event_EventService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'ivory.google_map.helper.subscriber.place.autocomplete.event.event' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'ivory'.\DIRECTORY_SEPARATOR.'google-map'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Helper'.\DIRECTORY_SEPARATOR.'Collector'.\DIRECTORY_SEPARATOR.'Place'.\DIRECTORY_SEPARATOR.'Event'.\DIRECTORY_SEPARATOR.'AutocompleteEventCollector.php';
        ...
        return $container->privates['ivory.google_map.helper.subscriber.place.autocomplete.event.event'] = new \Ivory\GoogleMap\Helper\Subscriber\Place\Event\AutocompleteSimpleEventSubscriber(($container->privates['ivory.google_map.helper.formatter'] ?? ($container->privates['ivory.google_map.helper.formatter'] = new \Ivory\GoogleMap\Helper\Formatter\Formatter(true))), new \Ivory\GoogleMap\Helper\Collector\Place\Event\AutocompleteEventCollector(), ($container->privates['ivory.google_map.helper.renderer.event.event'] ?? $container->load('getIvory_GoogleMap_Helper_Renderer_Event_EventService')));
    }
}
