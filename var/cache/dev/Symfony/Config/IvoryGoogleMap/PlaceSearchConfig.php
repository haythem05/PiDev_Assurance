...
require_once __DIR__.\DIRECTORY_SEPARATOR.'PlaceSearch'.\DIRECTORY_SEPARATOR.'BusinessAccountConfig.php';
...
class PlaceSearchConfig 
{
    ...
    public function businessAccount(array $value = []): \Symfony\Config\IvoryGoogleMap\PlaceSearch\BusinessAccountConfig
    {
        if (null === $this->businessAccount) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\PlaceSearch\BusinessAccountConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('business_account', $value)) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\PlaceSearch\BusinessAccountConfig($value['business_account']);
