...
require_once __DIR__.\DIRECTORY_SEPARATOR.'Elevation'.\DIRECTORY_SEPARATOR.'BusinessAccountConfig.php';
...
class ElevationConfig 
{
    ...
    public function businessAccount(array $value = []): \Symfony\Config\IvoryGoogleMap\Elevation\BusinessAccountConfig
    {
        if (null === $this->businessAccount) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\Elevation\BusinessAccountConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('business_account', $value)) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\Elevation\BusinessAccountConfig($value['business_account']);
