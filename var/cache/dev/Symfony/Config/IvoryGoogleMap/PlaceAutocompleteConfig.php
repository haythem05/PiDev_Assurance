...
require_once __DIR__.\DIRECTORY_SEPARATOR.'PlaceAutocomplete'.\DIRECTORY_SEPARATOR.'BusinessAccountConfig.php';
...
class PlaceAutocompleteConfig 
{
    ...
    public function businessAccount(array $value = []): \Symfony\Config\IvoryGoogleMap\PlaceAutocomplete\BusinessAccountConfig
    {
        if (null === $this->businessAccount) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\PlaceAutocomplete\BusinessAccountConfig($value);
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('business_account', $value)) {
            $this->_usedProperties['businessAccount'] = true;
            $this->businessAccount = new \Symfony\Config\IvoryGoogleMap\PlaceAutocomplete\BusinessAccountConfig($value['business_account']);
