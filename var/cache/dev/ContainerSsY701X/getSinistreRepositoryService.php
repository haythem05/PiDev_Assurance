 ...
 */
class getSinistreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SinistreRepository' shared autowired service.
     *
     * @return \App\Repository\SinistreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SinistreRepository.php';

        return $container->privates['App\\Repository\\SinistreRepository'] = new \App\Repository\SinistreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
